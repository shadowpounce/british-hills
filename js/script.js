...
function adaptiveSlider(documentWidth) {
    if (documentWidth >= 1280) {
        ...
        bulletSecond.addEventListener('click',() => {
            ...
            sliderWrapper.style.transform = `translate3d(-${sliderCard.offsetWidth + 30}px,0px,0px)`
    ...
    if (documentWidth >= 768 && documentWidth <= 1279) {
        ...
        bulletSecond.addEventListener('click',() => {
            ...
            sliderWrapper.style.transform = `translate3d(-${sliderCard.offsetWidth + 280}px,0px,0px)`
            bulletSecond.classList.add('bullet-active')
        })
    }
    ...
    if (documentWidth >= 480 && documentWidth <= 767) {
        ...
        bulletSecond.addEventListener('click',() => {
            ...
            sliderWrapper.style.transform = `translate3d(-${sliderCard.offsetWidth + 250}px,0px,0px)`
            bulletSecond.classList.add('bullet-active')
        })
    }
    ...
    if (documentWidth >= 320 && documentWidth <= 479) {
        ...
        bulletThird.addEventListener('click',() => {
            ...
            sliderWrapper.style.transform = `translate3d(-${sliderCard.offsetWidth * 2 + 59}px,0px,0px)`
